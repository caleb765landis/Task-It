...
<body>
  <?php
    ...
    if (isset($_POST['enter'])) {
      ...
      //{
        //It is always a good idea printing out the sql statement before sending it to the database
        //$sql = "select count(*) as c from REGISTRATION where username = '" . $username. "' and password = '".$pwd."'";
        //print $sql;

        $stmt = $con->prepare("select count(*) as c from USER where Username = ? and Password = ?");
  ...
  ?>
    ...
    <nav class="navbar navbar-dark navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-1"><a href="index.html" style="margin: 20px;">Home</a><a href="services.html" style="margin: 20px;">Services</a><a href="contact.html" style="margin: 20px;">Contact</a>
                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form action="login.php" method="post">
                              <?php print $msg; $msg=""; ?>
                              <div class="mb-3"><input class="form-control" id="username" type="username" name="username" placeholder="Username" style="color: var(--bs-dark);background: rgb(255,255,255);"></div>
                              <div class="mb-3"><input class="form-control" id="pwd" type="password" name="pwd" placeholder="Password" style="color: var(--bs-dark);background: rgb(255,255,255);"></div>
                              <div class="mb-3"><!--<a href="admin/dashboard.php">--><input class="btn btn-primary shadow d-block w-100" name="enter" type="submit" value="Log in"></input></a></div>
