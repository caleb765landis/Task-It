...
<body id="page-top">
    <?php
        ...
        /* ----------------- change to check if release is in project ----------------- */
		...
		if (isset($_POST['enter_release'])) {
            ...
            // insert release instance into database
            $releaseStmt = $con->prepare("INSERT into RELEASE_CONTAINER values (null, ?, ?, ?, ?, 1)");
            $releaseName = $name." - ".$version;
            $releaseStmt->execute(array($releaseName, $version, $_SESSION['projectID'], $startDate));
            $releaseStmt->closeCursor();

            // get release id of release we just created
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3"
                        ...
                        <h3 class="text-dark mb-1">Create Release</h3>
                            ...
                            <div class="col">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3" style="background: var(--bs-gray-200);">
                                        <h6 class="text-primary m-0 fw-bold">Create a Release</h6>
                                    </div>
                                    <div class="card-body" style="background: var(--bs-gray-100);">
                                        <form class="d-xxl-flex justify-content-xxl-center" action="createRelease.php"
                                            method="post">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col"><label class="col-form-label fs-6">Release
                                                            Name<input class="form-control" type="text" name="name"
                                                                value="New Release"></label></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col"><label class="col-form-label fs-6">Current
                                                            Version<input class="form-control" type="number"
                                                                name="version" value="1.0" min="0" step=".1"></label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col d-xxl-flex justify-content-xxl-end">
                                                        <a class="btn btn-primary"
                                                            ...
                                                            <input
                                                            class="btn btn-primary" type="submit" name="enter_release"
